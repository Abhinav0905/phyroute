...
\input{introduction_related.tex}
\input{methods_draft.tex}
...
\input{generated_tables/nominal.tex}
...
\input{generated_tables/mismatch.tex}
...
\input{generated_tables/latency.tex}
...
The reproducibility package is available at \url{https://github.com/Abhinav0905/phyroute}. Software release v0.2.0 is archived at \url{https://doi.org/10.5281/zenodo.22905467}. It contains the protocol and amendment, topology allocation, configuration and source hashes, non-executable model arrays, reference-coverage records, evaluation tables and plotting and timing code. Large scenario and physics arrays are regenerable with the supplied serial pipeline; their metadata and hashes are retained in the archive. The original exploratory experiment is preserved separately.
